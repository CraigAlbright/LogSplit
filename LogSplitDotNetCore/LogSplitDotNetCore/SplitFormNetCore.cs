...
{
    public partial class SplitFormNetCore : Form
    {
        ...
        private void OpenSourceFileDialogButtonClicked(object sender, EventArgs e)
        {
            ...
            _destinationPath = string.Concat(Path.GetDirectoryName(ofd.FileName),"\\");
        ...
        private void SplitFileButtonClicked(object sender, EventArgs e)
        {
            if (_stream == null)
            {
                ...
                if (_stream == null)
                {
                    MessageBox.Show(ResourcesNetCore.ResourcesNetCore.FileDoesntExist, ResourcesNetCore.ResourcesNetCore.FileDoesntExistCaption, MessageBoxButtons.OK);
                    return;
                }
            }
            if (int.TryParse(SplitSizeSpinEdit.Text, out _chunkSize))
            {
                ...
                MessageBox.Show(string.Format(ResourcesNetCore.ResourcesNetCore.SplitIsDone, _splitNumber, _destinationPath), ResourcesNetCore.ResourcesNetCore.DoneZo, MessageBoxButtons.OK);
            }
