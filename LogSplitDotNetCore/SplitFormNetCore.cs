    ...
    public partial class SplitFormNetCore : Form
    {
        ...
        private void SplitFileButtonClicked(object sender, EventArgs e)
        {
            if (_stream == null)
            {
                ...
                if (_stream == null)
                {
                    MessageBox.Show(ResourcesNetCore.FileDoesntExist, ResourcesNetCore.FileDoesntExistCaption, MessageBoxButtons.OK);
                    return;
                }
            }
            if (int.TryParse(SplitSizeSpinEdit.Text, out _chunkSize))
            {
                ...
                MessageBox.Show(string.Format(ResourcesNetCore.SplitIsDone, _splitNumber, _destinationPath), ResourcesNetCore.DoneZo, MessageBoxButtons.OK);
            }
